...
readline.add_argument('-p', '--push', action = 'store_true', help = 'Send'
                             'notification to configured mobile device. The file '
                             '~/.config/push.py.ini must be configured.')
...
readline.add_argument('crn', metavar = 'CRN', type = int, help = 'Course request '
                      'number.')
